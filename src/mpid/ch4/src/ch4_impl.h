...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX MPIDI_CH4U_win_target_t *MPIDI_CH4U_win_target_add(MPIR_Win * win, int rank)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX MPIDI_CH4U_win_target_t *MPIDI_CH4U_win_target_find(MPIR_Win * win, int rank)
{
    ...
    MPIDI_CH4U_win_target_t *target_ptr = NULL;
    MPL_HASH_FIND(hash_handle, MPIDI_CH4U_WIN(win, targets),
            &rank, sizeof(int), target_ptr);
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPL_STATIC_INLINE_PREFIX void MPIDI_CH4U_win_target_delete(MPIR_Win * win, MPIDI_CH4U_win_target_t * target_ptr)
{
